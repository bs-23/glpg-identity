...
const { partnerHcpSchema, partnerHcoSchema, partnerVendorSchema } = require('./partner.schema');
...
module.exports = app => {
    app.route('/api/partner/hcp')
        ...
        .post(passport.authenticate('application-jwt', { session: false }), multer.array('documents', 5), validate(partnerHcpSchema), controller.createPartnerHcp);
    ...
    app.route('/api/partner/hco')
        ...
        .post(passport.authenticate('application-jwt', { session: false }), multer.array('documents', 5), validate(partnerHcoSchema), controller.createPartnerHco);
    ...
    app.route('/api/partner/vendor')
        ...
        .post(passport.authenticate('application-jwt', { session: false }), multer.array('documents', 5), validate(partnerVendorSchema), controller.createPartnerVendor);
