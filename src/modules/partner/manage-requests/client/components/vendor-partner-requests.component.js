            ...
            return (<React.Fragment key={item.id}>
                <div className="col-12 col-sm-6 col-lg-4">
                     <div className="form-group">
                        <label className="font-weight-bold d-flex align-items-center justfy-content-between" htmlFor={companyCodeId}>
                            <span> {`Company Code ${idx + 1}`} <span className="text-danger">*</span></span>
                            <i className="fas fa-minus-circle text-danger hover-opacity ml-auto" type="button" title="Remove" onClick={() => removeCompanyCode(idx)}></i>
                        </label>
