                    ...
                    <div className="col-12">
                        <div className="d-sm-flex justify-content-between align-items-end mb-0 mt-3">
                            <div>
                                ...
                                <div className="pt-3">
                                    <NavLink className="custom-tab px-3 py-3 cdp-border-primary font-weight-normal" to="/business-partner/requests/hcps"><i className="fas fa-user-md fa-1_5x mr-2"></i>Health Care Professionals</NavLink>
                                    <NavLink className="custom-tab px-3 py-3 cdp-border-primary font-weight-normal" to="/business-partner/requests/hcos"><i className="fas fa-hospital fa-1_5x mr-2"></i>Health Care Organizations</NavLink>
                                </div>
                            </div>
