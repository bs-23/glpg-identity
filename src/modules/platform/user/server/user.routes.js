...
module.exports = app => {
    ...
    app.route('/api/cdp-users')
        .post(CDPAuthStrategy, ServiceGuard([Services.MANAGE_USER]), controller.getUsers);

    app.route('/api/users')
        .post(CDPAuthStrategy, ServiceGuard([Services.MANAGE_USER]), controller.createUser);
