...
import ConsentCategories from './consent-category/categories.component';
...
export default function HcpRoutes() {
    ...
    return (
        <Switch>
            ...
            <PrivateRoute path={`${path}/consent-categories`} component={ConsentCategories} module={'privacy'} />
        </Switch>
    );
}
