                ...
                <div className="row justify-content-center">
                    <div className="col-12 col-md-12 col-lg-9">
                        <div className="forbidden__panel p-3 p-md-5 bg-white text-center">
                            ...
                            <h2 className="forbidden__header pb-3 pt-3 pt-sm-t pb-sm-5"><img className="forbidden__image" alt="Access Forbidden" src="/assets/images/access_forbidden.svg" height="195" /></h2>
                            <h4 className="forbidden__subheader font-weight-bold pb-3">Access Forbidden!</h4>
                            <p className="forbidden__text pb-5 font-weight-bold mb-0">Sorry, the page you are trying to access has restrictions.<br className="d-none d-md-block" /> You don't have permission to access that.</p>
