                ...
                <div className="row justify-content-center">
                    <div className="col-12 col-md-12 col-lg-9">
                        <div className="forbidden__panel p-3 p-md-5 bg-white text-center">
                            ...
                            <p className="forbidden__text pb-5 font-weight-bold">Sorry, the page you are trying to access has restrictions.<br className="d-none d-md-block" /> You don't have permission to access that.</p>
