...
async function getConditionsWithDetails(req, res) {
    ...
    let conditions = [
        ...
        <p>Autosomal dominant polycystic kidney disease is mainly an inherited condition caused by cells in the kidney not developing properly, which results in the kidney not working properly. It is thought that 1 in 500 to 1 in 2,500 have this medical condition. While the impact of the disease can vary widely from person to person, it can result in difficult-to-manage symptoms, such as back pain, high blood pressure, headaches and kidney stones. There is no cure for autosomal dominant polycystic kidney disease; however, most associated symptoms can be managed with treatments. For some patients, additional treatment, such as dialysis – where a machine replaces kidney function – or a transplant, may be required. </p>
        <p>Along with support from your doctor, there are also specific patient association websites that can help you understand more about your condition and give ideas on how to manage it, and provide you with access to a network of other patients and caregivers who have the same condition.</p>
        ...
        <p>Crohn’s disease is a chronic medical condition that affects the bowel and causes inflammation to occur in the digestive tract. It results in a wide range of symptoms including diarrhea, stomach pain, blood in stools, and weight loss. Symptoms can come and go over time, which can have a significant impact on day-to-day life and make it difficult to manage. While the exact cause is unknown and there is currently no cure, symptoms can be reduced or effectively controlled through a range of treatments.</p>
        <p>Along with support from your doctor, specific patient association websites can help you understand more about your condition and give ideas on how to manage it, and provide you with access to a network of other patients and caregivers who have the same condition.</p>
        <p>Galapagos is committed to developing treatments for medical conditions with an unmet need, such as Crohn’s disease. To find out if there is a clinical trial relevant to you, speak to your doctor. You can also search for relevant Galapagos clinical trials on this site.</p>`},
        ...
        <p>Along with support on treatment and management from your doctor, specific patient association websites can help you understand more about your condition and give ideas on how to manage it, and provide you with access to a network of patients and caregivers who have the same condition.</p>
        ...
        <p>Along with support on treatment and management from your doctor, specific patient association websites can help you understand more about your condition and give ideas on how to manage it, and provide you with access to a network of other patients and caregivers who have the same condition.</p>
        ...
        <p>Along with support on treatment and management from your doctor, specific patient association websites can help you understand more about your condition and give ideas on how to manage it, and provide you with access to a network of other patient and caregivers who have the same condition.</p>
        ...
        <p>Along with support on treatment and management from your doctor, specific patient association websites can help you understand more about your condition and give ideas on how to manage it, and provide you with access to a network of others who have the same condition.</p>
        ...
        <p>Systemic sclerosis is a chronic autoimmune condition in which the immune system becomes overactive and attacks the connective tissue that sits under the skin, which leads to hardened areas forming. The exact symptoms can differ from person to person, with some people experiencing symptoms affecting the internal organs and blood vessels. It’s not clear why this happens to the immune system, meaning it has been difficult to develop specific treatments; however, your doctor can support you on how to best manage the disease.</p>
        <p>Along with support on treatment and management from your doctor, specific patient association websites can help you understand more about your condition and give ideas on how to manage it, and provide you with access to a network of patients and caregivers who have the same condition.</p>
