                                    ...
                                    <div className="profile-detail__row pb-0 pb-sm-2 d-block d-sm-flex">
                                        ...
                                        <div className="profile-detail__col pb-3 pr-0 pr-sm-3">
                                            ...
                                            <span className="profile-detail__value">
                                                {countries && countries.length > 0 && userInfo.countries.length ? userInfo.countries.map((country) => countries.find(i => i.country_iso2 === country).countryname).join(', ') : nullValueToken}
                                            </span>
                                        </div>
                                    </div>
                                    <div className="profile-detail__row pb-0 pb-sm-2 d-block d-sm-flex">
