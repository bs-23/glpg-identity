...
const clinicalTrialsUrl = nodecache.getValue('POSTGRES_CLINICAL_TRIALS_URL');
...
exports.clinitalTrialsConnector = new Sequelize(`${clinicalTrialsUrl}/${clinicalTrialsDatabase}`, {logging: false});
