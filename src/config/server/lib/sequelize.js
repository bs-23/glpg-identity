...
exports.cdpConnector = new Sequelize(`${postgresCdpUrl}/${postgresCdpDatabase}`);
exports.datasyncConnector = new Sequelize(`${postgresDatasyncUrl}/${postgresDatasyncDatabase}`);
exports.clinitalTrialsConnector = new Sequelize(`${postgresCdpUrl}/${clinicalTrialsDatabase}`);
