    ...
    sonarqubeScanner({
        ...
        options: {
            'sonar.sources': `src/modules/core/server,
                ...
                src/modules/privacy/consent-category/client,
                src/modules/privacy/consent-category/server,
                src/modules/privacy/consent-country/client,
                src/modules/privacy/consent-country/server,
                src/modules/privacy/consent-performance/client,
                src/modules/privacy/consent-performance/server,
                src/modules/privacy/manage-consent/client,
                src/modules/privacy/manage-consent/server,
