...
async function init() {
    ...
    require(path.join(process.cwd(), 'src/modules/privacy/consent-import/server/consent-import-job.model'));
        ...
        User.findOne({ where: { email: 'glpg@brainstation-23.com' } }).then(admin => {
            ...
            const consentLocales = [
                ...
                },
                {
                    ...
                    locale: 'fr_BE',
                    veeva_consent_type_id: 'a3w0C0000008jPwQAI'
                },
                {
                    ...
                    consent_id: '01cfab4f-9fdd-4975-9a90-bbde78785109',
                    locale: 'nl_BE',
                    veeva_consent_type_id: 'a3w4J000000bzysQAA'
                },
                {
